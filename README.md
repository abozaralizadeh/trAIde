...
`strategyEdge.gateScoreboard` (Sep 25 2026) adds the [gate scoreboard](#gate-scoreboard--measuring-the-directional-gates-report-only): per directional gate and side, what the gate blocks against what it allows on the same day — percent returns, SEs, t, counts and verdicts only.
