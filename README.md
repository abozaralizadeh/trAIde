...
| `PROFIT_LOCK_TRAIL_ARM_R` | `1.0` | Arm the trailing ratchet once the peak favourable run reaches this multiple of initial risk. Below 1R a "profit" is inside the noise the stop was drawn around; arming at 0.5 collapsed the average win to +0.35R vs a -1.05R average loss |
