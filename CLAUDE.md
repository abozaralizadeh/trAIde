...
- **Spot dust is not a position** (`agent.reconcile_spot_positions`, `SPOT_DUST_VALUE_USD`, shared with `main._discover_unlisted_holdings`): a $0.005 KCS remainder once sent the model to place TP/SL on dust every few runs.
