...
def run_trading_agent(
  ...
  instructions = (
    ...
    "Your DEFAULT is to find and place a trade. Decline only when research clearly shows the wrong conditions "
    "(strong opposing trend, negative news catalyst, RSI extreme in wrong direction). "
    "'Mixed signals' is NOT a reason to decline — it is a reason to use smaller size.\n\n"
    ...
    "## Drawdown adaptation (informational — no hard block):\n"
    "- drawdownPct 5–15%: reduce position size by ~25%, prefer higher-conviction setups.\n"
