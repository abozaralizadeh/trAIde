...
async def run_trading_agent(
  ...
  instructions = (
    ...
    "- If no clean setups, hand off to the Research Agent for other coins/sources; adopt new ones only with clear evidence and a logged decision. Use research outputs (log_research, backtests) before committing capital.\n"
    ...
    f"- Futures leverage must stay <= {snapshot.max_leverage}x; if unsure, prefer spot.\n"
    ...
    "- Keep at least 10% of USDT untouched as reserve.\n"
