...
def run_supervisor_agent(
  ...
  async def get_config_summary() -> Dict[str, Any]:
    ...
    return {
      ...
      "preferred_venue": cfg.trading.preferred_venue,
      "tp_fee_buffer_pct": cfg.trading.tp_fee_buffer_pct,
      "sl_atr_multiplier_min": cfg.trading.sl_atr_multiplier_min,
      "sl_atr_multiplier_max": cfg.trading.sl_atr_multiplier_max,
      "researcher_auto_enabled": cfg.trading.researcher_auto_enabled,
